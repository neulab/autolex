...
for lang in $LANGS
do
	git rm -rf $lang/Agreement/Gender/*freq $lang/Agreement/Gender/*feats
	git rm -rf $lang/Agreement/Person/*freq $lang/Agreement/Person/*feats
	git rm -rf $lang/Agreement/Number/*freq $lang/Agreement/Number/*feats
	git rm -rf $lang/Agreement/Tense/*freq $lang/Agreement/Tense/*feats
	git rm -rf $lang/Agreement/Mood/*freq $lang/Agreement/Mood/*feats
	git rm -rf $lang/Agreement/*txt

	git rm -rf $lang/WordOrder/*freq $lang/WordOrder/*feats $lang/WordOrder/*txt
	
	git rm -rf $lang/CaseMarking/*freq $lang/CaseMarking/*feats $lang/CaseMarking/*txt
	git rm -rf $lang/CaseMarking/*/*freq $lang/CaseMarking/*/*feats $lang/CaseMarking/*/*txt
